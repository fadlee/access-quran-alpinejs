...
`
  ...
  function Pe(e, t, r, n, i) {
    if (Ie && typeof t == "function") {
      ...
      o instanceof Promise
        ? o.then((s) => Pe(e, s, r, n)).catch((s) => te(s, i, t))
        : e(o);
    } else
    ...
    if (t === "clear") s.forEach(c);
      ...
      switch ((r !== void 0 && c(s.get(r)), t)) {
        case "add":
          H(e)
            ? qe(r) && c(s.get("length"))
            : (c(s.get(Z)), ie(e) && c(s.get(It)));
          break;
        case "delete":
          H(e) || (c(s.get(Z)), ie(e) && c(s.get(It)));
          break;
        case "set":
          ie(e) && c(s.get(Z));
          break;
  ...
  function gi(e = !1) {
    return function (r, n, i, o) {
      let s = r[n];
      if (!e && ((i = h(i)), (s = h(s)), !H(r) && Pt(s) && !Pt(i)))
        return (s.value = i), !0;
  ...
  y(
    "refs",
    (e) => (e._x_refs_proxy || (e._x_refs_proxy = B(Pi(e))), e._x_refs_proxy)
  );
  function Pi(e) {
    let t = [];
    return (
